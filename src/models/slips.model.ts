...
export class SlipsModel extends Model {
    ...
    public async retrieveIdFromSlip(slipData: ISlipPrototype): Promise<string> {
        // TODO: test this
        let retrieved = await this.nosqlClient.getIdFromData(slipData);
        return retrieved;
    }
    ...
    public async getSlipByNumber(slipNumber: number): Promise<any> {
        ...
        let slip = await this.nosqlClient.runQueryForModel(query);
        return slip;
    }
    ...
    public async createSlip(_number: number): Promise<any> {
        ...
        let saved = await this.nosqlClient.datastoreSave(SLIPS, newSlip);
        return saved;
    }

    public async deleteSlip(slipId: string): Promise<any> {
        // TODO: diagnose delete issue. Slips not being deleted
